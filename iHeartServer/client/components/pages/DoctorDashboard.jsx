	...
	render() {
        ...
        <nav className="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div className="navbar-header">
                ...
                <a className="navbar-brand" href="index.html">iHeart</a>
            </div>
            {/*Top Menu Items*/}
            ...
            <div className="collapse navbar-collapse navbar-ex1-collapse">
                <ul className="nav navbar-nav side-nav">
                    <li className="active">
                        <a href="index.html"><i className="fa fa-fw fa-dashboard"></i> Alerts </a>
                    </li>
                    <li>
                        <a href="charts.html"><i className="fa fa-fw fa-bar-chart-o"></i> Patients</a>
                    </li>
                </ul>
            </div>
            {/*/.navbar-collapse*/}
